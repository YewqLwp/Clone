...
(function (factory) {
    ...
    Rating.prototype = {
        ...
        _generateRating: function () {
            ...
            //edit by CY
            if (self.displayOnly)
                self.$filledStars.attr('title', 'Rating: ' + self.initialValue);
            self._renderCaption();
            self._renderClear();
            self._initHighlight();
            $container.append($el);
        ...
        _init: function (options) {
            ...
            //edited by CY
            var self = this, $el = self.$element.addClass('starhide');
        ...
        fetchCaption: function (rating) {
            ...
            if (self.displayOnly)
             {
                var totalReview = self.$element.attr("data-totalReview");
                if (parseInt(totalReview) > 0)
                    return '<span class="text-muted"> (' + self.$element.attr("data-totalReview") + ')</span>';
                else
                    return "";
            }
            //edited by CY end
